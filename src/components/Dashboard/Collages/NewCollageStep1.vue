    ...
    <div class="create-collage-box">
      ...
      <div class="first-step">
        ...
        <div class="collage-type">
          ...
          <button @click="selectCollageType('SCREEN', $event)" disabled>
            Screen Collage
          </button>
          <button @click="selectCollageType('PRINTABLE', $event)" disabled>
            Printable Collage
          </button>
        </div>
      </div>
  ...
  watch: {
    collageName: function (val) {
      ...
      if (this.collageName == "") {
        ...
        $(".create-collage#step1 .collage-type button").attr("disabled", false);
      }
    },
  },
};
